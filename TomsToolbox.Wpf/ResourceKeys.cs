namespace TomsToolbox.Wpf
{
    ...
    public static class ResourceKeys
    {
        ...
        /// </summary>
        [NotNull] public static readonly ResourceKey AutoToolTipTextBoxStyle = new ComponentResourceKey(typeof(ResourceKeys), "AutoToolTipTextBoxStyle");

        /// <summary>
        /// Resource key for a style applying a shared with to associated container controls.
        /// </summary>
        [NotNull] public static readonly ResourceKey SharedWidthContainerStyle = new ComponentResourceKey(typeof(ResourceKeys), "SharedWidthContainerStyle");
        ...
        /// </summary>
        [NotNull] public static readonly ResourceKey ListBoxItemCheckBoxStyle = new ComponentResourceKey(typeof(ResourceKeys), "ListBoxItemCheckBoxStyle");

        /// <summary>
        /// Data grid with check boxes for row selection: Style to be applied to the check box inside the row header template.
        /// </summary>
        [NotNull] public static readonly ResourceKey DataGridRowCheckBoxStyle = new ComponentResourceKey(typeof(ResourceKeys), "DataGridRowCheckBoxStyle");
        ...
        /// </summary>
        [NotNull] public static readonly ResourceKey ControlWithValidationErrorToolTipStyle = new ComponentResourceKey(typeof(ResourceKeys), "ControlWithValidationErrorToolTipStyle");
    }
}
