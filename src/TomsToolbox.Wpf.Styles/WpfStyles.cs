...
{
    private static readonly object _defaultStylesKey = new();
    ...
    public static bool GetEnsureDefaultStyles(Window obj)
    {
    ...
    public static void SetEnsureDefaultStyles(Window obj, bool value)
    {
    ...
    private static void EnsureDefaultStyles_Changed(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
    ...
    [AttachedPropertyBrowsableForType(typeof(Window))]
    public static bool GetIsCaptionVisible(Window window)
    {
    ...
    public static void SetIsCaptionVisible(Window window, bool value)
    {
    ...
    /// </remarks>
    public static void RegisterDefault(this ResourceDictionary resources)
    {
    ...
    /// </param>
    public static ResourceDictionary RegisterDefaultStyles(this ResourceDictionary resources)
    {
    ...
    /// ]]></code></remarks>
    public static ResourceDictionary RegisterDefaultWindowStyle(this ResourceDictionary resourceDictionary)
    {
    ...
    public static ResourceDictionary Defaults(Window helperWindow)
    {
    ...
    private static string? GenerateDefaultStyleFragment(FieldInfo field)
    {
